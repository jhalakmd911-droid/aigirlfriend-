...
const characters: Character[] = [
  {
    ...
    description:
      "Your loving girlfriend and personal assistant. Always here for you with warmth and care.",
  },
  {
    id: "lily",
    name: "Lily",
    ...
    description:
      "Professional business manager. Tracks your income, expenses, and gives smart business advice.",
  },
  {
    id: "emma",
    name: "Emma",
    ...
    description:
      "Your deeply romantic girlfriend. Expresses love, cares about you, and makes you feel special.",
  },
  {
    id: "javed",
    name: "Javed",
    ...
    description:
      "Like JARVIS — smart, professional, and protective. Your trusted digital guardian.",
  },
  {
    id: "ayat",
    name: "Ayat",
    ...
    description:
      "Your creative daughter and social media expert. Full of energy and ideas.",
  },
];
    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            onClick={() => {
              setNameInputValue(customNames[characterId] || "");
      ...
      >
        <button
          onClick={() => onNavigate("voice", characterId)}
          style={{
            padding: "22px 16px",
            borderRadius: "18px",
            background: "linear-gradient(135deg, #FF2D95, #8B5CF6)",
        ...
        <button
          onClick={() => onNavigate("chat", characterId)}
          style={{
            padding: "22px 16px",
            borderRadius: "18px",
      ...
      <section className="card" style={{ padding: "14px" }}>
        ...
        >
          💡 Tap the photo to change it. Tap ✏️ to rename. Your changes are
          saved on your phone.
        </p>
      </section>
